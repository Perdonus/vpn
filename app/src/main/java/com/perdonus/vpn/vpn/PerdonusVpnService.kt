...
class PerdonusVpnService : VpnService() {
    ...
    companion object {
        const val ACTION_START = "com.perdonus.vpn.action.START"
        const val ACTION_STOP = "com.perdonus.vpn.action.STOP"
        const val ACTION_TOGGLE = "com.perdonus.vpn.action.TOGGLE"
